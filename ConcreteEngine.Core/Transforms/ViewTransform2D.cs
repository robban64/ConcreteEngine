...
public sealed class ViewTransform2D
{
    ...
    {
        get => _zoom;
        set { _zoom = MathF.Max(Math.Min(value, 4),0.1f); _dirty = true; }
    } // >1: zoom in, <1: zoom out

    public Vector2D<int> ViewportSize
    {
        get => _viewportSize;
        set { _viewportSize = value; _dirty = true; }

    }
    public Matrix4x4 ViewMatrix           { get { Ensure(); return _viewMat; } }
    public Matrix4x4 ProjectionMatrix     { get { Ensure(); return _projectionMat; } }
    public Matrix4x4 ProjectionViewMatrix         { get { Ensure(); return _viewMat * _projectionMat; } }
