...
{
    public static GenericRequest<EditorAssetCategory, List<AssetObjectViewModel>>? FillAssetStoreView { get; set; }
    public static GenericRequest<int, List<AssetObjectFileViewModel>>? FillAssetObjectFiles { get; set; }
    public static GenericRequest<int, List<EntityRecord>>? FillEntityView { get; set; }
