...
public readonly struct GfxMetaChanged<TMeta>(int Id, in TMeta meta, ushort generation, bool recreated, ResourceKind kind) where TMeta : unmanaged, IResourceMeta
{
