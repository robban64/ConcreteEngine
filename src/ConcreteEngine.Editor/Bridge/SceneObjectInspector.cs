...
public sealed class SceneObjectInspector
{
    ...
    public SceneObjectInspector(SceneObject sceneObject)
    {
...
internal sealed class AnimationFields
{
    ...
    public AnimationFields(AnimationProperty animation)
    {
        ...
        SpeedField = new FloatField<Float1Value>("Speed", FieldWidgetKind.Drag,
            () => _animation.Speed,
            value => _animation.Speed = (float)value) { Format = "%.3f", Speed = 0.01f, Min = 0 };
        DurationField = new FloatField<Float1Value>("Duration", FieldWidgetKind.Drag,
            () => _animation.Duration,
            value => _animation.Duration = (float)value) { Format = "%.3f", Speed = 0.01f, Min = 0 };
    }
}
...
{
    // Definition
    public readonly ParticleBlueprint Particle;
    ...
    public ParticleFields(ParticleBlueprint particle)
    {
        Particle = particle;
        ...
        SpeedMinMaxField = new FloatField<Float2Value>("Speed Min / Max", FieldWidgetKind.Drag,
            ...
            value => Particle.Definition.SpeedMinMax = (Vector2)value) { Format = "%.3f",Delay = FieldGetDelay.Medium };
