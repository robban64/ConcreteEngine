...
internal static class InspectorProvider
{
    ...
    public static void RegisterCamera()
    {
        ...
        Inspector<Camera>.Register(
            ...
            new FloatInput<Float3>(nameof(Camera.Translation), FieldKind.Input) { Format = "%.3f" },
        ...
        Inspector<Camera>.Register(
            ...
            new FloatInput<Float2>(nameof(Camera.Orientation), FieldKind.Input) { Format = "%.3f" },
        ...
        Inspector<Camera>.Register(
            "Fov",
            new FloatInput<Float1>("Field of view", FieldKind.Slider) { Min = 10f, Max = 179f },
