...
{
    private bool HasMetricSidebar { get; } =
        LeftSidebar == LeftSidebarMode.Metrics && RightSidebar == RightSidebarMode.Metrics;
    ...
    public static ModeState MakeCli() => new(ViewMode.Cli, LeftSidebarMode.Default, RightSidebarMode.Default);
