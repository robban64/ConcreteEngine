...
internal static class InputFieldDrawer
{
    ...
    public static unsafe delegate*<int, ref byte, ref float, ref byte, float, float, float, bool> BindFloat(
    ...
    public static bool DrawInputInt(int c, ref byte label, ref int value, float speed, int min, int max) =>
        c switch
        {
    ...
    public static bool DrawSliderInt(int c, ref byte label, ref int value, float speed, int min, int max) =>
        c switch
        {
    ...
    public static bool DrawDragInt(int c, ref byte label, ref int value, float speed, int min, int max) =>
        c switch
        {
