...
*/
    ...
    private static readonly Vector2 IconBasePos = new((GridThumbnailSize - GridIconSize) * 0.5f,
        (GridThumbnailSize * 0.4f) - (GridIconSize * 0.5f));
    ...
    private void DrawFiles()
    {
        ...
        DrawFilesInner(count, columnCount);
    }
