            ...
            case TextureDescriptor tex:
                {
                    ...
                    if (tex.Filename != null) dict.Add("Source", tex.Filename);
                    else
                    {
                        for (var i = 0; i < tex.MultiFilenames!.Length; i++)
                        {
                            dict.Add(i.ToString(), tex.MultiFilenames[i]);
                        }
                    }
                    ...
                    return (record, Path.Combine(EnginePath.TexturePath, tex.Name));
                }
            ...
            case ShaderDescriptor shader:
                {
                    ...
                    var basePath = Path.ChangeExtension(Path.Combine(EnginePath.ShaderCorePath, shader.Name), null);
