...
internal sealed class AssetScanner
{
   ...
   // private Dictionary<AssetKind, List<AssetRecord>> _records;
...
*/
    ...
    private AssetRecord CreateDefaultDescriptor(string ext)
    {
        ...
        return kind switch
        {
            ...
            AssetKind.Shader => throw new InvalidOperationException("Shaders cannot be auto-discovered. Create the .asset file manually."),
