...
using static ConcreteEngine.Engine.Renderer.RenderLimits;
...
public sealed class MaterialBuffer : IDisposable
{
    ...
    internal unsafe ReadOnlySpan<TextureBinding> GetMetaAndSlots(Id16<Material> materialId, out RenderMaterialMeta meta)
    {
